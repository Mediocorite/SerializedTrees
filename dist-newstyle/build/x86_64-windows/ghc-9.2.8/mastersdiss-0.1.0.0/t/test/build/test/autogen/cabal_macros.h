...
#define VERSION_mastersdiss "0.1.0.0"
#endif /* VERSION_mastersdiss */
#ifndef MIN_VERSION_mastersdiss
#define MIN_VERSION_mastersdiss(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_mastersdiss */
...
/* package bytestring-builder-0.10.8.2.0 */
#ifndef VERSION_bytestring_builder
#define VERSION_bytestring_builder "0.10.8.2.0"
#endif /* VERSION_bytestring_builder */
#ifndef MIN_VERSION_bytestring_builder
#define MIN_VERSION_bytestring_builder(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  10 || \
  (major1) == 0 && (major2) == 10 && (minor) <= 8)
#endif /* MIN_VERSION_bytestring_builder */
/* package bytestring-strict-builder-0.4.5.6 */
#ifndef VERSION_bytestring_strict_builder
#define VERSION_bytestring_strict_builder "0.4.5.6"
...
#define CURRENT_COMPONENT_ID "mastersdiss-0.1.0.0-inplace-test"
